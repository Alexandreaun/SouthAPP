...
extension UIColor {
    ...
    public static let redDark: UIColor = UIColor(red:0.73, green:0.00, blue:0.00, alpha:1.00)
    public static let newGray: UIColor = UIColor(red: 0.85, green: 0.85, blue: 0.85, alpha: 1.00)
}
